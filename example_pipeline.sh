bin/FAST/fast.py -generate_mapping -i read
...
bin/vsearch --fastq_filter raw.cut.fastq --fastq_maxee 1 --fastaout raw.cut.trim.fasta --fasta_width

bin/FAST/fast.py -filter_seqs -i raw.cut.trim.fasta -o raw.cut.trim.N0.homop9.fasta -maxN 0 -maxhomop 9

bin/FAST/fast.py -stat_seqs -i raw.trim.N0.homop9.fasta -o qc_report.txt
...
bin/vsearch raw.qc.derep.size2.uchime.fasta --centroids raw.qc.vsearch.fasta --fasta_width 0 -id 0.97 --sizein --uc raw.qc.uc.txt
...
bin/FAST/fast.py -rarefy_otu_table -otu otu_table.txt -o otu.table.rare.txt -d 3000 -iter 1000 -t 4
...
bin/FAST/assign_taxonomy.py -otu otu_table.rare.txt -tax taxonomy_blast.txt -o otu_table.rare.tax.txt
