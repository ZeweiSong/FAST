...
def main(name_space):
    ...
    parser.add_argument('-pident', default = 0.0, help='Threshod for minimum pident to keep in OTU table.')
    parser.add_argument('-match_length', default = 0.9, help='Threshold for matched length that can be assigned a taxa.')
